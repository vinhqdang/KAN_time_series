...
rather than bury it.} NoGAM \emph{clearly outperforms} SPADE at $d{=}6,10$
(five seeds each: $0.917\pm0.077$/$0.955\pm0.058$ vs.\ SPADE's
$0.876$/$0.885$); at $d{=}20$ its nominal edge ($0.906$ on a single seed vs.\
SPADE's $0.886\pm0.030$ over three) is smaller than SPADE's own seed-to-seed
spread there, so we report that one specifically as suggestive rather than
established --- on our own subsequent internal review pass we caught
ourselves initially stating this uniformly as ``at every width tested,''
which overstated the $d{=}20$ evidence, and corrected it. SCORE is roughly on par with
