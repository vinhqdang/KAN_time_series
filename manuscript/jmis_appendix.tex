...
study: $\lambda_g{=}5\times10^{-3}$, selected via a sensitivity sweep on
held-out validation seeds disjoint from the seeds reported in
Table~\ref{tab:instdag}, after finding the earlier $\lambda_g{=}0.02$ was
over-regularized for this task---see Section~\ref{sec:instdag}), gradient clipping at $5.0$,
...
Two further settings were corrected during this revision, each via a
...
reran the affected configurations once.
